...
var LemonadeStand = /*#__PURE__*/function () {
  function LemonadeStand() {
    ...
    this.signs = 0;
    this.price = 0;
    this.lastDayProfit = 0; // Track last day's profit
  ...
  return _createClass(LemonadeStand, [{
    ...
    value: function displayGameState() {
      ...
      switch (this.currentState) {
        case this.gameState.SETUP:
          ...
          var previousDayInfo = '';
          if (this.day > 1) {
            previousDayInfo = "\nYESTERDAY'S RESULTS:\nProfit/Loss: ".concat(this.lastDayProfit >= 0 ? '+' : '', "$").concat(this.lastDayProfit.toFixed(2));
          }
    ...
    value: function runSimulation() {
      ...
      // Store this day's profit for next day's display
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e46b61d9bdab3d6ecbf9")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3657910095258fa321cb.hot-update.js.map