    ...
    value: function displayGameState() {
      ...
      switch (this.currentState) {
        case this.gameState.SETUP:
          ...
          var previousDayInfo = '';
          if (this.day > 1) {
            var lastProfit = this.assets - this.previousDayAssets;
            previousDayInfo = "\nYESTERDAY'S RESULTS:\nProfit/Loss: ".concat(lastProfit >= 0 ? '+' : '', "$").concat(lastProfit.toFixed(2));
          }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3657910095258fa321cb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.47c5eb4b6368689fec19.hot-update.js.map