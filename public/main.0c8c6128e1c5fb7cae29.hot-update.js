...
var LemonadeStand = /*#__PURE__*/function () {
  ...
  return _createClass(LemonadeStand, [{
    ...
    value: function calculateDemand(glasses, signs, price) {
      ...
      var n1 = price < 0.25 ? 30 - 60 * price : 8 / (price * price);
      ...
      switch (this.currentWeather) {
        ...
        case this.weather.CLOUDY:
          weatherMultiplier = 0.6; // Bad for business
          break;
        default:
      ...
      // First few signs are effective, then drops off
      var signEffect = signs > 0 ? 1 + Math.log(signs) * 0.2 : 1;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7c2068b03d108d1224fe")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.0c8c6128e1c5fb7cae29.hot-update.js.map